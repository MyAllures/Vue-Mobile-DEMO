...
import ChatGameBody from '@/screens/games/ChatGameBody'
import ChatGameFooter from '@/screens/games/ChatGameFooter'
import ChatGameCategory from '@/screens/games/ChatGameCategory'
...
export default {
      ...
      messages: [
        {
          ...
          'sender': {
            'username': 'dohua2',
            'nickname': 'eggtar2',
            'avatar_url': 'https://www.dropbox.com/s/1sm6ouigp7c9qnj/image-200160-725910.jpeg?dl=0',
            'is_manager': false
          }
        },
        {
          'content': '456測試456測試測試456測試測試456測試測試456測試測試456測試測試456測試測試測試',
          'sender': {
            'username': 'dohua2',
            'nickname': 'eggtar2',
            'avatar_url': 'https://www.dropbox.com/s/1sm6ouigp7c9qnj/image-200160-725910.jpeg?dl=0',
        ...
        {
          'content': '456測試測試456測試測試456測試測試456測試測試456測試測試456測試測試456測試測試456測試測試',
          'sender': {
            'username': 'eeeeee',
            'nickname': 'eeeeee',
            'avatar_url': 'https://www.dropbox.com/s/1sm6ouigp7c9qnj/image-200160-725910.jpeg?dl=0',
  ...
  watch: {
    ...
    'betTrackNewDialog.isSuccess': function (isSuccess) {
      if (isSuccess) {
        this.$set(this, 'playReset', !this.playReset)
      }
    },
