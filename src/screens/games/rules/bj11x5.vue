<template>
  <section class="rule-details">
    <ul>
      <li>「北京11选5」是由国家体育总局发行，体育彩票管理中心承销。</li>
      <li>每日共开奖42期、每20分钟开奖1次。每次由1~11个号码随机摇出“5个”数字做为开奖号码；并依据押中的号码个数或玩法获得不同等级的奖金。</li>
      <li>官方网站：<a href="http://www.bjlot.com/help_new/help-11s5.shtml" target="_blank">北京体彩网</a></li>
    </ul>
    <h3>
