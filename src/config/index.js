export const customPlayGroups = [
  ...
  {
    // 六合彩 连码
    code: ['hkl_ca-m_wc', 'luckl_ca-m_wc', 'cshkl_ca-m_wc'],
    component: 'WithCode',
    options: Array.from(Array(49).keys()).map(item => item + 1)
  },
  {
    // 六合彩 连肖
    code: ['hkl_ca-m_exl', 'luckl_ca-m_exl', 'cshkl_ca-m_exl'],
    component: 'hk6Exl'
  },
  {
    // 六合彩 连尾
    code: ['hkl_ca-m_exltail', 'luckl_ca-m_exltail', 'cshkl_ca-m_exltail'],
    component: 'hk6Exl'
  },
  {
    // 六合彩 和肖
    code: ['hkl_ca-m_shxia', 'luckl_ca-m_shxia', 'cshkl_ca-m_shxia'],
    component: 'shxiaZdc',
    options: Array.from(Array(12).keys()).map(item => item)
  },
  {
    // 六合彩 自選不中
    code: ['hkl_ca-m_ntinfvr', 'luckl_ca-m_ntinfvr', 'cshkl_ca-m_ntinfvr'],
    component: 'shxiaZdc',
    options: Array.from(Array(49).keys()).map(item => item + 1)
  },
  {
...
export const HKL_GAMES = ['hkl', 'luckl', 'cshkl']
